...
async def main():
    ...
    try:
        ...
        # List tools
        print("\nListing tools...")
        await write_line(process.stdin, {"jsonrpc": "2.0", "id": 2, "method": "listTools", "params": {}})
        ...
        # List resources
        print("\nListing resources...")
        await write_line(process.stdin, {"jsonrpc": "2.0", "id": 3, "method": "listResources", "params": {}})
