...
class UserGetToolHandler(KalturaToolHandler):
    ...
    def get_tool_definition(self) -> types.Tool:
        ...
        return types.Tool(
            ...
            inputSchema={
                "type": "object",
                "properties": {"user_id": {"type": "string", "description": "ID of the user to retrieve"}},
                "required": ["user_id"],
            },
        )
...
class UserAddToolHandler(KalturaToolHandler):
    ...
    async def handle(
        ...
        try:
            ...
            # Add the user
            result = await self.kaltura_client.execute_request("user", "add", user=user)
    ...
    def get_tool_definition(self) -> types.Tool:
        ...
        return types.Tool(
            ...
            inputSchema={
                "type": "object",
                "properties": {
                    "id": {"type": "string", "description": "User ID (unique identifier)"},
...
class UserUpdateToolHandler(KalturaToolHandler):
    ...
    async def handle(
        ...
        try:
            ...
            current_user = await self.kaltura_client.execute_request("user", "get", userId=user_id)
            ...
            updated_user = await self.kaltura_client.execute_request("user", "update", userId=user_id, user=user)
        ...
        return types.Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "screenName": {"type": "string", "description": "New screen name for the user"},
                    "role_ids": {
                        "type": "string",
...
class UserDeleteToolHandler(KalturaToolHandler):
    ...
    async def handle(
        ...
        try:
            ...
            # Delete the user
            await self.kaltura_client.execute_request("user", "delete", userId=user_id)
    ...
    def get_tool_definition(self) -> types.Tool:
        ...
        return types.Tool(
            ...
            inputSchema={
                "type": "object",
                "properties": {"user_id": {"type": "string", "description": "ID of the user to delete"}},
                "required": ["user_id"],
            },
        )
                ...
                "properties": {
                    "filter": {
                        ...
                        "properties": {
                            ...
                            "idEqual": {"type": "string", "description": "Filter by user ID"},
                            "statusEqual": {"type": "integer", "description": "Filter by status"},
