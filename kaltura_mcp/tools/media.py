        ...
        try:
            ...
            if "ENTRY_ID_NOT_FOUND" in str(e):
                try:
                    ...
                    data_entry = await self.kaltura_client.execute_request("data", "get", entryId=entry_id)
...
class MediaDeleteToolHandler(KalturaToolHandler):
    ...
    async def handle(
        ...
        try:
            ...
            current_entry = await self.kaltura_client.execute_request("media", "get", entryId=entry_id)

            # Delete the entry
            await self.kaltura_client.execute_request("media", "delete", entryId=entry_id)
    ...
    def get_tool_definition(self) -> types.Tool:
        ...
        return types.Tool(
            ...
            inputSchema={
                "type": "object",
                "properties": {"entry_id": {"type": "string", "description": "ID of the media entry to delete"}},
                "required": ["entry_id"],
            },
        )
...
class MediaUpdateToolHandler(KalturaToolHandler):
    ...
    async def handle(
        ...
        try:
            ...
            updated_entry = await self.kaltura_client.execute_request("media", "update", entryId=entry_id, mediaEntry=entry)
        ...
        return types.Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "name": {"type": "string", "description": "New name for the media entry"},
                    "description": {
                        "type": "string",
