...
class CategoryGetToolHandler(KalturaToolHandler):
    ...
    async def handle(
        ...
        # Execute request
        try:
            category = await self.kaltura_client.execute_request("category", "get", id=category_id)
            ...
            if "CATEGORY_NOT_FOUND" in str(e) or "not found" in str(e).lower():
                raise ValueError(f"Category not found: {category_id}") from e
    ...
    def get_tool_definition(self) -> types.Tool:
        ...
        return types.Tool(
            ...
            inputSchema={
                "type": "object",
                "properties": {"id": {"type": "integer", "description": "ID of the category to retrieve"}},
                "required": ["id"],
            },
        )
...
class CategoryAddToolHandler(KalturaToolHandler):
    ...
    async def handle(
        ...
        try:
            ...
            # Add the category
            result = await self.kaltura_client.execute_request("category", "add", category=category)
...
class CategoryUpdateToolHandler(KalturaToolHandler):
    ...
    async def handle(
        ...
        try:
            ...
            current_category = await self.kaltura_client.execute_request("category", "get", id=category_id)
            ...
            updated_category = await self.kaltura_client.execute_request("category", "update", id=category_id, category=category)
        ...
        return types.Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "tags": {"type": "string", "description": "New comma-separated list of tags"},
                },
                "required": ["id"],
            },
        )
