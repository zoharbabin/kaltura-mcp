...
class TestUserIntegration:
    ...
    async def test_user_list_tool(self, server):
        ...
        result = await server.app.call_tool("kaltura.user.list", {"page_size": 10, "page": 1})
    ...
    async def test_user_get_tool(self, server, kaltura_client):
        ...
        list_result = await server.app.call_tool("kaltura.user.list", {"page_size": 1, "page": 1})
        ...
        result = await server.app.call_tool("kaltura.user.get", {"id": user_id})
    ...
    async def test_user_add_update_delete_flow(self, server):
        ...
        # 1. Add the user
        add_result = await server.app.call_tool(
            "kaltura.user.add",
            {
                "id": user_id,
        ...
        # 3. Delete the user
        delete_result = await server.app.call_tool("kaltura.user.delete", {"id": user_id})
        ...
        get_result = await server.app.call_tool("kaltura.user.get", {"id": user_id})
