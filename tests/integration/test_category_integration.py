...
class TestCategoryIntegration:
    ...
    async def test_category_list_tool(self, server):
        ...
        result = await server.app.call_tool("kaltura.category.list", {"page_size": 10, "page": 1})
    ...
    async def test_category_get_tool(self, server, kaltura_client):
        ...
        list_result = await server.app.call_tool("kaltura.category.list", {"page_size": 1, "page": 1})
        ...
        result = await server.app.call_tool("kaltura.category.get", {"id": category_id})
    ...
    async def test_category_add_update_delete_flow(self, server):
        ...
        try:
            ...
            delete_result = await server.app.call_tool("kaltura.category.delete", {"id": category_id})
