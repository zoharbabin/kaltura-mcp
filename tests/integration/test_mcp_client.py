...
async def run_client_tests(server_url="http://127.0.0.1:8765"):
    ...
    try:
        ...
        logger.info("\n=== Test 3: List Media Entries ===")
        result = await client.call_tool("kaltura.media.list", {"page_size": 5})  # Limit to 5 entries
        ...
        add_result = await client.call_tool(
            ...
            {"name": category_name, "description": "Created by MCP test client"},
        )
        ...
        get_result = await client.call_tool("kaltura.category.get", {"id": category_id})
        ...
        update_result = await client.call_tool("kaltura.category.update", {"id": category_id, "name": updated_name})
        ...
        delete_result = await client.call_tool("kaltura.category.delete", {"id": category_id})
