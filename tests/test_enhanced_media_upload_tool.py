...
from KalturaClient.Plugins.Core import KalturaMediaType, KalturaUploadTokenStatus
...
async def test_enhanced_media_upload_tool(mock_kaltura_client):
    ...
    with patch('kaltura_mcp.utils.mime_utils.guess_kaltura_entry_type', return_value="media"), \
         ...
         patch('kaltura_mcp.utils.chunked_uploader.ChunkedUploader.upload_file', return_value="test_token_id"):
...
async def test_enhanced_media_upload_document(mock_kaltura_client):
    ...
    # Mock MIME type detection
    with patch('kaltura_mcp.utils.mime_utils.guess_kaltura_entry_type', return_value="document"), \
...
async def test_enhanced_media_upload_data(mock_kaltura_client):
    ...
    # Mock MIME type detection
    with patch('kaltura_mcp.utils.mime_utils.guess_kaltura_entry_type', return_value="data"), \
