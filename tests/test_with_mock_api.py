...
class TestMediaWithMockAPI:
    ...
    async def test_media_list_tool(self, mock_server):
        ...
        result = await mock_server.app.call_tool("kaltura.media.list", {
            "page_size": 10,
            "page": 1
        })
    ...
    async def test_media_get_tool(self, mock_server):
        ...
        list_result = await mock_server.app.call_tool("kaltura.media.list", {
            "page_size": 1,
            "page": 1
        })
        ...
        result = await mock_server.app.call_tool("kaltura.media.get", {
            "entry_id": entry_id
        })
    ...
    async def test_media_upload_update_delete_flow(self, mock_server):
        ...
        with patch('kaltura_mcp.tools.enhanced_media.ChunkedUploader') as mock_uploader_class:
            ...
            try:
                # 1. Upload the media
                upload_result = await mock_server.app.call_tool("kaltura.media.upload", {
        ...
        # 2. Update the media
        update_result = await mock_server.app.call_tool("kaltura.media.update", {
            "entry_id": entry_id,
        ...
        # 3. Delete the media
        delete_result = await mock_server.app.call_tool("kaltura.media.delete", {
            "entry_id": entry_id
        })
        ...
        get_result = await mock_server.app.call_tool("kaltura.media.get", {
            "entry_id": entry_id
        })
...
class TestCategoryWithMockAPI:
    ...
    async def test_category_list_tool(self, mock_server):
        ...
        result = await mock_server.app.call_tool("kaltura.category.list", {
            "page_size": 10,
            "page": 1
        })
    ...
    async def test_category_add_update_delete_flow(self, mock_server):
        ...
        # 1. Add the category
        add_result = await mock_server.app.call_tool("kaltura.category.add", {
        ...
        update_result = await mock_server.app.call_tool("kaltura.category.update", {
            "id": category_id,
        ...
        delete_result = await mock_server.app.call_tool("kaltura.category.delete", {
            "id": category_id
        })
        ...
        try:
            get_result = await mock_server.app.call_tool("kaltura.category.get", {
                "id": category_id
            })
            # If we get here, the category wasn't deleted properly
            assert False, "Category should have been deleted"
...
class TestUserWithMockAPI:
    ...
    async def test_user_list_tool(self, mock_server):
        ...
        result = await mock_server.app.call_tool("kaltura.user.list", {
            "page_size": 10,
            "page": 1
        })
    ...
    async def test_user_add_update_delete_flow(self, mock_server):
        ...
        # 1. Add the user
        add_result = await mock_server.app.call_tool("kaltura.user.add", {
            "id": user_id,
        ...
        # 2. Update the user
        update_result = await mock_server.app.call_tool("kaltura.user.update", {
            "id": user_id,
        ...
        # 3. Delete the user
        delete_result = await mock_server.app.call_tool("kaltura.user.delete", {
            "id": user_id
        })
        ...
        get_result = await mock_server.app.call_tool("kaltura.user.get", {
            "id": user_id
        })
...
class TestResourcesWithMockAPI:
    ...
    async def test_media_resources(self, mock_server):
        ...
        list_resource = await mock_server.app.call_tool("kaltura.media.list", {
            "page_size": 10,
            "page": 1
        })
    ...
    async def test_category_resources(self, mock_server):
        ...
        list_result = await mock_server.app.call_tool("kaltura.category.list", {
            "page_size": 1,
            "page": 1
        })
    ...
    async def test_user_resources(self, mock_server):
        ...
        list_result = await mock_server.app.call_tool("kaltura.user.list", {
            "page_size": 1,
            "page": 1
        })
