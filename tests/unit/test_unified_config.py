...
from kaltura_mcp.config import load_config, Config, KalturaConfig, ServerConfig, LoggingConfig, ContextConfig
...
class TestUnifiedConfig:
    ...
    def test_load_yaml_config(self):
            ...
            original_env = {}
            env_vars_to_clear = [
                "KALTURA_PARTNER_ID", "KALTURA_ADMIN_SECRET", "KALTURA_USER_ID", "KALTURA_SERVICE_URL",
                "KALTURA_MCP_LOG_LEVEL", "KALTURA_MCP_TRANSPORT", "KALTURA_MCP_PORT", "KALTURA_MCP_HOST",
                "KALTURA_MCP_DEBUG", "KALTURA_MCP_LOG_FILE", "KALTURA_MCP_CONTEXT_STRATEGY",
                "KALTURA_MCP_MAX_ENTRIES", "KALTURA_MCP_MAX_CONTEXT_SIZE"
            ]
