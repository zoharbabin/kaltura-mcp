...
try:
    from KalturaClient.Plugins.Core import (
        ...
        KalturaMediaEntryListResponse,
        KalturaMediaEntryStatus,
        KalturaMediaType,
...
class MockKalturaAPI:
    ...
    async def list_media(
        self, filter_params: Optional[Dict[str, Any]] = None, pager: Optional[Dict[str, int]] = None
    ) -> KalturaMediaEntryListResponse:
        ...
        # Create response
        response = KalturaMediaEntryListResponse(objects=paged_entries, totalCount=len(filtered_entries))
    ...
    async def list_categories(
        ...
        # Create response
        response = KalturaCategoryListResponse(objects=paged_categories, totalCount=len(filtered_categories))
    ...
    async def list_users(
        ...
        # Create response
        response = KalturaUserListResponse(objects=paged_users, totalCount=len(filtered_users))
...
class MockKalturaClientWrapper:
    ...
    async def add_data_entry(self, dataEntry=None, **kwargs):
        ...
        data_entry.description = (
            dataEntry.description if dataEntry and hasattr(dataEntry, "description") else kwargs.get("description", "")
        )
